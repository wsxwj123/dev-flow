...
9. **每步明说（必须用大白话，不许报术语）**：进入每个阶段、每次调技能或工具前，先用一句人话告诉用户接下来做什么——**说效果，不说工具名/角色名/模型名**。反面（禁止）："派 opus 审查代理盲审方案""调用 grilling 技能""用 AskUserQuestion 确认"。正面（照这样说）："我让另一个 AI 假装不认识这份方案、专门来挑毛病""我来仔细追问你几个问题，把需求抠清楚""下面几个岔路想请你拍板"。让用户始终知道在干嘛，但不用懂背后那些工具叫什么。这是铁律1"说人话"在流程动作上的延伸——说人话是**全程**要求，汇报、明说、提问、解释风险，一律大白话。
